...
GCC_BIN =
PROJECT = shed_boat
OBJECTS = ./main.o ./NMEA/nmea.o ./HMC5883L/HMC5883L.o \
...
CC_SYMBOLS = -DTARGET_RTOS_M4_M7 -DTARGET_FF_ARDUINO -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -DTARGET_KPSDK_MCUS -DTARGET_FRDM -DTARGET_CORTEX_M -DCPU_MK64FN1M0VMD12 -D__FPU_PRESENT=1 -DTARGET_Freescale -DMBED_BUILD_TIMESTAMP=1454516547.7 -DTARGET_M4 -D__MBED__=1 -DTARGET_K64F -DTARGET_KPSDK_CODE -D__CORTEX_M4 -DFSL_RTOS_MBED -DTARGET_MCU_K64F -DARM_MATH_CM4
